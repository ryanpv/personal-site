              ...
              <div className='py-4 flex justify-center'>
                <div className='w-full flex flex-col lg:flex-row'>
                  ...
                  <div className='md:w-2/3 flex flex-col'>
                    ...
                    <a className='pl-2 text-base text-white font-medium leading-6 text-primary-500 hover:text-primary-600 dark:hover:text-primary-400' href='https://www.polishbycin.com' target='_blank' rel='noreferrer'>
                      <div className='flex m'>
                        <BsArrowRight />
                        &nbsp; Visit the site
                      </div>
                    </a>
                    <a className='pl-2 text-base text-white font-medium leading-6 text-primary-500 hover:text-primary-600 dark:hover:text-primary-400' href='https://github.com/ryanpv/beauty-service-app' target='_blank' rel='noreferrer'>
                      <div className='flex m'>
                        <BsArrowRight />
                        &nbsp; See the GitHub
                      </div>
